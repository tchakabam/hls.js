...
export class PlaylistKey {
  constructor (baseUrl, relativeUri) {
    this.method = null;
    this.key = null;
    this.iv = null;
    ...
    this._resolvedUrlCached = null;
  }

  get uri () {
    if (!this._resolvedUrlCached && this._relativeUri) {
      this._resolvedUrlCached = URLToolkit.buildAbsoluteURL(
        this._baseUrl, 
        this._relativeUri, 
        { alwaysNormalize: true }
      );
    }
    return this._resolvedUrlCached;
  }
}

export class Playlist {
    constructor(attributeList) {
        this._type = PlaylistType.LIVE;
        this._version = null;
        this._url = null;
        this._fragments = [];
        this._live = true;
        this._startSequenceNo = null;
        this._attrs = attributeList;
        this._key = new PlaylistKey();
      }
